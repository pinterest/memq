...
public class NetworkClient implements Closeable {
  ...
  /**
   * Points the activeConnection away from the existing connection to allow the old connection to drain. Nothing will happen if there is no active connection
   */
  public void drain() {
    if (activeConnection != null && activeConnection.channel() != null) {
      // let the old connection drain and clean up active connection such that the next request can create a new connection
  ...
  /**
   * updates the status of the channel, and returns the previous state
   * @param channelId the channelId of the channel to be updated
   * @param status the new status of the channel
   * @return the previous status of the channel
   */
  public ConnectionStatus updateConnectionStatus(ChannelId channelId, ConnectionStatus status) {
