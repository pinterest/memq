...
public class MemqMessageHeader2 {
  ...
  public MemqMessageHeader2(ByteBuf byteBuf) {
  ...
  public MemqMessageHeader2(ByteBuffer buf) {
  ...
  public MemqMessageHeader2(DataInputStream stream) throws IOException {
   ...
   * @param taskRequest
   */
  public MemqMessageHeader2(TaskRequest taskRequest) {
    this.taskRequest = taskRequest;
  }

  public MemqMessageHeader2(BufferedRequest request) {
